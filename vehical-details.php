...
<title>Alquiler de Motos | Detalles de Motocicleta</title>
<!--Bootstrap -->
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap">
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Resumen Motocicleta </a></li>
...
<?php }} ?>
      ...
      <aside class="col-md-3">
        ...
        <div class="share_vehicle">
          <p>Compartir: <a href="https://www.facebook.com/mauriciosevilabritto"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a href="https://twitter.com/configuroweb"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a href="https://www.linkedin.com/in/mauricio-sevilla/"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a></p>
        </div>
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="date" class="form-control" name="fromdate" placeholder="Desde (dd/mm/año)" required>
            </div>
            <div class="form-group">
              <input type="date" class="form-control" name="todate" placeholder="To Hasta (dd/mm/año)" required>
            </div>
            <div class="form-group">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Accede para hacer tu reserva</a>
