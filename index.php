      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Encuentra tu moto perfecta</h1>
            <p>Tenemos las mejores a tu disposición</p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Encuentra la mejor <span>moto para ti</span></h2>
      <p>¡Podrás disfrutar plenamente de tus vacaciones y tu viaje! ¿Algún problema? ¡Nuestro apasionado equipo estará encantado de ayudarte! ¡No pierda el tiempo durante sus vacaciones para encontrar un punto de alquiler en el lugar! ¡Sin barrera del idioma, gracias a nuestro equipo multilingüe! ¡Al mismo precio que pagaría en el acto! Tenemos las mejores motocicletas con las mejores ofertas.</p>
    </div>
    <div class="row">
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Nueva Moto</a></li>
        </ul>
      </div>
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-motorcycle " aria-hidden="true"></i>50+</h2>
            <p>Nuevas Motos</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-motorcycle " aria-hidden="true"></i>120+</h2>
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Testimonios de <span>Nuestros Clientes</span></h2>
    </div>
    <div class="row">
