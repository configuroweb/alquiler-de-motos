...
<head>
	...
	<title>Alquiler de Coches | Crear Marca</title>
				...
				<div class="row">
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Formulario de Crear Marcas</div>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php }
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Nombre de Marca</label>
												<div class="col-sm-8">
