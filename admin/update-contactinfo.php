...
$query->execute();
$msg="Información de Contacto Actualizada Exitósamente";
}
?>
...
<head>
	...
	<title>Alquiler de Coches | Actualizar Información de Contacto</title>
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Actualizar Información de Contacto</div>
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Actualizar Información</button>
												</div>
											</div>
