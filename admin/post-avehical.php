...
if($lastInsertId)
{
$msg="Moto publicada exitósamente";
}
else
{
...
<head>
	...
	<title>Alquiler de Coches | Pubicar Motocicleta</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Publicar una Motocicleta</h2>
...
<label class="col-sm-2 control-label">Nombre Motocicleta<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Descripción de Motocicleta<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Coste por día (en COP)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" required>
</div>
<label class="col-sm-2 control-label">Selecciona Tipo de Combustible<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Capacidad de Sillas<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="brakeassist"> Freno trasero </label>
</div>
</div>
...
<input type="checkbox" id="powersteering" name="powersteering" value="1">
<label for="inlineCheckbox5"> Amortiguadores </label>
</div>
</div>
...
<label for="crashcensor"> Sensor de choque </label>
</div></div>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="leatherseats" name="leatherseats" value="1">
<label for="leatherseats"> Sillas de Cuero </label>
</div>
</div>
</div>
