...
$query -> execute();
$msg="Registro de Motocicleta eliminado exitósamente";
}
...
<head>
	...
	<title>Alquiler de Coches | Gestionar Motocicletas</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gestionar Motocicletas</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Detalle de Motocicletas</div>
...
<a href="manage-vehicles.php?del=<?php echo $result->id;?>" onclick="return confirm('Deseas eliminar el registro');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
