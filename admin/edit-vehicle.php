...
$msg="Datos actualizados exitósamente";
...
<head>
	...
	<title>Alquiler de Coches | Editar Información de Motocicleta</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Editar Información de Motocicleta</h2>
...
<label class="col-sm-2 control-label">Motocicleta<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required>
</div>
<label class="col-sm-2 control-label">Selecciona Marca<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Descripción Motocicleta<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Precio por día (en COP)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label class="col-sm-2 control-label">Capacidad Sillas<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<label for="inlineCheckbox2"> Encendido Electrónico </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Freno trasero </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Seguro Conductor</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Seguro Pasajero </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Reproductor de Música </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Amortiguadores </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Sillas de Cuero </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
