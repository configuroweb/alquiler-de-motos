...
$msg="Reserva cancelada exitósamente";
}
...
$msg="Reserva confirmada exitósamente";
}
...
<head>
	...
	<title>Alquiler de Coches | Gestionar Reservas</title>
...
if($result->Status==0)
{
echo htmlentities('No confirmado');
...
echo htmlentities('Confirmado');
 	...
 	echo htmlentities('Cancelado');
										...
										<td><a href="manage-bookings.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿Realmente deseas confirmar esta reserva?')"> Confirmar</a> /


<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('¿Realmente deseas cancelar esta reserva?')"> Cancelar</a>
</td>
