...
<title>Alquiler de Coches | Mi Perfil</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Configuraciones Generales</h5>
          <?php
         if($msg){?><div class="succWrap"><strong>Proceso Exitoso </strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
