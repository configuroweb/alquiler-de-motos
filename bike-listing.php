...
<title>Alquiler de Coches | Lista de Motos</title>
<!--Bootstrap -->
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Listadas</span></p>
</div>
</div>
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Encuentra tu Motocicleta </h5>
          </div>
...
<option value="Cas">Gas</option>
                </select>
              </div>

              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Buscar Moto</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-motorcycle" aria-hidden="true"></i> Motos agregadas recientemente</h5>
          </div>
