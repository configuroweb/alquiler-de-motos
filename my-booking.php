...
<title>Alquiler de Coches | Mis Reservas </title>
<!--Bootstrap -->
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>Desde:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>Hasta:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Cancelado</a>
            <div class="clearfix"></div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">No confirmado</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
